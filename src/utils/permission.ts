...
function requestIOS(permissionID: any) {
...
function requestAndroid(permissionID: any) {
  return new Promise((resolve, reject) => {
...
const permission = {
  get isIOS() {
    return (typeof isIOS as any) === 'boolean' ? isIOS : (isIOS = uni.getSystemInfoSync().platform === 'ios');
  },
  requestIOS,
  requestAndroid,
